...
DLL_GLOBAL cvar_t	ag_version = { "sv_aura_version","1.0mini", FCVAR_SERVER };
#else
DLL_GLOBAL cvar_t	ag_version = { "sv_aura_version","1.0", FCVAR_SERVER };
#endif
...
DLL_GLOBAL cvar_t	ag_vote_kick = { "sv_aura_vote_kick","0" };                     //Kick voting is disabled by default.
